...
if(isset($_SESSION['student'])) { ?>
  ...
  $credentials = "user = postgres password=123456";
		...
		<?php 
		$sql = pg_query($db, "select * from show_meetinglist()");
		...
		<section class="section">
			...
			<div style="margin-top: 70px; padding: 00px 105px;">
			...
			<br>
				<h2 style="background: #4CAF50!important; padding: 10px 20px; font-size: 20px; font-weight: bold; color: white;">All Meeting</h2> <br> 
				<table class="table table-bordered">
					...
					<tbody>
						<?php while ($row = pg_fetch_assoc($sql)) {
							...
							<td><a href="createstudygroup.php?id=<?php echo $row['id']; ?>" style="background: #607d8b!important; color: white; padding: 10px; font-weight: bold; box-shadow: 5px 4px 8px #888888; border-radius: 2px;">Create New Study Group </a>
							</td>
